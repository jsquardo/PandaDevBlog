    ...
    <div className="flex items-center w-12 h-6">
      {mounted && (
        <Switch
          ...
          className={`${isDark ? "bg-ctp-overlay0" : "bg-ctp-overlay1"}
        ...
        >
          ...
          <svg
            ...
            } border-2 border-transparent absolute h-6 w-6 text-ctp-text dark:text-ctp-text transition ease-in-out duration-200`}
          >
            {isDark ? (
              <path
                fillRule="evenodd"
          ...
          <span
            ...
            } bg-ctp-base pointer-events-none inline-block h-6 w-6 rounded-full shadow-lg transform ring-0 transition ease-in-out duration-200  `}
          ></span>
        </Switch>
      )}
    </div>
