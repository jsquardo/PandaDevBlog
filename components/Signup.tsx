...
export function Signup({ className }: { className?: string }) {
  ...
  return (
    <div
      className={clsx(
        "shadow-cm mb-10 sm:rounded-md text-gray-900 dark:text-gray-100 dark:bg-gray-800",
        className
      )}
    >
      <form onSubmit={subscribe}>
        <div className="grid sm:grid-cols-2">
          <div className="p-12 font-gil bg-gray-100 dark:bg-gray-700 sm:rounded-tl-md sm:rounded-bl-md sm:rounded-tr-none rounded-tl-md rounded-tr-md">
            <h3 className="text-xl font-bold leading-6 mb-5">
              Subscribe to the Newsletter
            </h3>
            <p className="leading-7 mb-5 font-helv">
            ...
            <div className="mb-4">
              <div className="mb-3">
                <input
                  ...
                  className="appearance-none font-helv rounded-md relative block bg-white dark:bg-gray-900 w-full px-3 py-3 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-600 text-gray-700 dark:text-gray-300 focus:outline-none"
                  value={fName}
              ...
              <button
                type="submit"
                className="bg-pink-600 rounded-full font-helv py-3 px-6 text-gray-50 hover:bg-pink-500"
              >
